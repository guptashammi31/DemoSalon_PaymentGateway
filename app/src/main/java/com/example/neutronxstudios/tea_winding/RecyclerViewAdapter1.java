...
public class RecyclerViewAdapter1 extends RecyclerView.Adapter<RecyclerViewAdapter1.ViewHolder> {
    ...
    public RecyclerViewAdapter1(Context context, List<BookingDetails> TempList) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements com.example.neutronxstudios.tea_winding.ViewHolder {
