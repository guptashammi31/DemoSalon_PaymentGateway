...
public class SalonConfirmationListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salon_confirmation_list);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(SalonConfirmationListActivity.this));

        // Assign activity this to progress dialog.
        progressDialog = new ProgressDialog(SalonConfirmationListActivity.this);
